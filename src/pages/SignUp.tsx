...
const SignUp = () => {
  ...
  const userRole = location.state?.role || localStorage.getItem('userRole') || 'patient';
  ...
  const handleSocialSignup = (provider: 'google' | 'facebook') => {
    ...
    console.log(`${provider} signup for ${userRole}`);
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-center">
              Sign Up as {userRole === 'doctor' ? 'Doctor' : 'Patient'}
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" className="w-full">
                Create {userRole === 'doctor' ? 'Doctor' : 'Patient'} Account
              </Button>
            </form>
